...
impl App {
            ...
            egui::Window::new("Configure Mod Options")
                ...
                .show(ctx, |ui| {
                    egui::Frame::none().inner_margin(8.0).show(ui, |ui| {
                        ...
                        ui.horizontal(|ui| {
                            if ui
                                .icon_text_button("Add Option Group", uk_ui::icons::Icon::Add)
                                .clicked()
                            {
                                builder
                                    .meta
                            ...
                            egui::CollapsingHeader::new(group_name)
                                ...
                                .show(ui, |ui| {
                                    ...
                                    ui.horizontal(|ui| {
                                        ...
                                        {
                                            *opt_group =
                                                OptionGroup::Exclusive(ExclusiveOptionGroup {
                                                    default: None,
                                                    name: std::mem::take(opt_group.name_mut()),
                                                    description: std::mem::take(
                                                        opt_group.description_mut(),
                                                    ),
                                                    options: std::mem::take(
                                                        opt_group.options_mut(),
                                                    ),
                                                });
                                        }
                                        if ui
                                    ...
                                    if let OptionGroup::Exclusive(group) = opt_group {
                                        ...
                                        let def_name = group
                                            ...
                                            .as_ref()
                                            .and_then(|opt| {
                                                group.options.iter().find_map(|o| {
                                                    o.path.eq(opt).then(|| o.name.as_str())
                                                })
                                            })
                                            .unwrap_or("None");
                                        egui::ComboBox::new(id, "Default Option")
                                            ...
                                            .show_ui(ui, |ui| {
                                                group.options.iter().for_each(|opt| {
                                                    let selected =
                                                        group.default.as_ref() == Some(&opt.path);
                                                    if ui
                                                        .selectable_label(
                                                            selected,
                                                            opt.name.as_str(),
    ...
    pub fn render_packger(&self, ui: &mut Ui) {
        egui::Frame::none().inner_margin(8.0).show(ui, |ui| {
            ...
            ui.horizontal(|ui| {
                if ui
                    .icon_text_button("Manage Options", uk_ui::icons::Icon::Tune)
                    .clicked()
                {
